...
import io.spring.initializr.generator.spring.code.CustomCompilationUnitCustomizer;
import io.spring.initializr.generator.spring.code.CustomSourceCodeCustomizer;
import io.spring.initializr.generator.spring.code.CustomSourceCodeProjectContributor;
...
public class JavaProjectGenerationConfiguration {
	...
	@Bean
	public CustomSourceCodeProjectContributor<JavaTypeDeclaration, JavaCompilationUnit, JavaSourceCode> CustomJavaSourceCodeProjectContributor(
			ObjectProvider<CustomApplicationTypeCustomizer<?>> customApplicationTypeCustomizers,
			ObjectProvider<CustomCompilationUnitCustomizer<?, ?>> customCompilationUnitCustomizers,
			ObjectProvider<CustomSourceCodeCustomizer<?, ?, ?>> customSourceCodeCustomizers) {
		return new CustomSourceCodeProjectContributor<>(this.description, JavaSourceCode::new,
				new JavaSourceCodeWriter(this.indentingWriterFactory), customApplicationTypeCustomizers,
				customCompilationUnitCustomizers, customSourceCodeCustomizers);
	}
