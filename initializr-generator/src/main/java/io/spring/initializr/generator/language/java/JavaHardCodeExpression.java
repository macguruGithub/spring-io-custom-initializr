...
public class JavaHardCodeExpression extends JavaStatement {
	...
	public void mainMethod(JavaTypeDeclaration typeDeclaration) {
		value = typeDeclaration.getName();
	}
	...
	public Map<String, String> getData() {
		...
		data.put("main",
				"String environmentName=System.getenv(ENVIRONMENT_NAME);\r\n"
						+ "new SpringApplicationBuilder().sources(" + value + ".class)\r\n"
						+ ".profiles(StringUtils.isEmpty(environmentName)?\"local\":environmentName)\r\n"
						+ ".build()\r\n" + ".run(args)");
		return data;
	}
